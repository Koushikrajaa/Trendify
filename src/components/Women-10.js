...
import MenSh1 from './wc10-1.jpeg'
import MenSh2 from './wc10-3.jpeg'
import MenSh3 from './wc10-2.jpeg'
import MenSh4 from './wc10-4.jpeg'
...
function Women10 (){
    ...
    var [total, setTotal] = useState(820);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(820 * (quantity + 1))
        setfinalPrice((820*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="ratings">4.6 | 457 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹820</p>
