...
import MenSh1 from './wat2-1.jpeg'
import MenSh2 from './wat2-2.jpeg'
import MenSh3 from './wat2-3.jpeg'
import MenSh4 from './wat2-4.jpeg'
import sale1 from './sale_banner12.jpg'
import sale2 from './sale_banner3.jpg'
...
function Watch2 (){
    ...
    var [total, setTotal] = useState(899);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(899 * (quantity + 1))
        setfinalPrice((899*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="ratings">3.2 | 126 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹899</p>
            <p class="base-price">₹999</p>
            <p class="dis-available">(10% Off)</p>
