...
import MenSh1 from './sun1-1.jpeg'
import MenSh2 from './sun1-2.jpeg'
import MenSh3 from './sun1-3.jpeg'
import MenSh4 from './sun1-4.jpeg'
import sale1 from './sale_banner11.jpg'
import sale2 from './sale_banner12.jpg'
...
function Sun1 (){
    ...
    var [total, setTotal] = useState(775);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(775 * (quantity + 1))
        setfinalPrice((775*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Carlton London</p>
            <p class="shirt-name">Men Polarised & UV Protected Sunglasses</p>
            <p class="ratings">3.5 | 378 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹775</p>
            <p class="base-price">₹2145</p>
