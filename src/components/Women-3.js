...
import MenSh1 from './wc4-1.jpeg'
import MenSh2 from './wc4-2.jpeg'
import MenSh3 from './wc4-3.jpeg'
import MenSh4 from './wc4-4.jpeg'
...
function Women3 (){
    ...
    var [total, setTotal] = useState(384);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(384 * (quantity + 1))
        setfinalPrice((384*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">HERE&NOW</p>
            <p class="shirt-name">Women Yellow & Green Cotton Kurta</p>
            <p class="ratings">4.0 | 562 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹384</p>
