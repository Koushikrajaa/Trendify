...
import MenSh1 from './wc1-1.jpeg'
import MenSh2 from './wc1-3.jpeg'
import MenSh3 from './wc1-2.jpeg'
import MenSh4 from './wc1-4.jpeg'
...
function Women1 (){
    ...
    var [total, setTotal] = useState(373);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(373 * (quantity + 1))
        setfinalPrice((373*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Women Maroon & White Striped Kurta</p>
            <p class="ratings">3.9 | 347 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹373</p>
