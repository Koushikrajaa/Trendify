...
import MenSh1 from './wc11-1.jpeg'
import MenSh2 from './wc11-2.jpeg'
import MenSh3 from './wc11-3.jpeg'
import MenSh4 from './wc11-4.jpeg'
...
function Women11 (){
    ...
    var [total, setTotal] = useState(849);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(849 * (quantity + 1))
        setfinalPrice((849*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Pistaa</p>
            <p class="shirt-name">Women Grey & Pink Floral Print Kurta</p>
            <p class="ratings">4.5 | 954 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹849</p>
            <p class="base-price">₹1999</p>
            <p class="dis-available">(62% Off)</p>
