...
import MenSh1 from './sun3-1.jpeg'
import MenSh2 from './sun3-2.jpeg'
import MenSh3 from './sun3-3.jpeg'
import MenSh4 from './sun3-4.jpeg'
...
function Sun3 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">OKNO</p>
            <p class="shirt-name">Aviators with UV Protected Lens</p>
            <p class="ratings">3.8 | 348 Ratings</p>
            <hr class="hr-line"></hr>
