...
import MenSh1 from './wc8-1.jpeg'
import MenSh2 from './wc8-2.jpeg'
import MenSh3 from './wc8-3.jpeg'
import MenSh4 from './wc8-4.jpeg'
import sale1 from './sale_banner.jpg'
import sale2 from './sale_banner2.jpg'
...
function Women7 (){
    ...
    var [total, setTotal] = useState(454);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(454 * (quantity + 1))
        setfinalPrice((454*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Libas</p>
            <p class="shirt-name">Women Peach & Pink Floral Print Kurta</p>
            <p class="ratings">4.0 | 263 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹454</p>
            <p class="base-price">₹1299</p>
            <p class="dis-available">(65% Off)</p>
