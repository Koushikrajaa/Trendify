...
import MenSh1 from './cm5-1.jpeg'
import MenSh2 from './cm5-2.jpeg'
import MenSh3 from './cm5-3.jpeg'
import MenSh4 from './cm5-4.jpeg'
...
function Men8 (){
    ...
    var [total, setTotal] = useState(430);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(430 * (quantity + 1))
        setfinalPrice((430*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">HIGHLANDER</p>
            <p class="shirt-name">Men Black & White Printed Casual Shirt</p>
            <p class="ratings">3.5 | 458 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹430</p>
            <p class="base-price">₹1049</p>
            <p class="dis-available">(59% Off)</p>
