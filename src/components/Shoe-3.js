...
import MenSh1 from './sh3-1.jpeg'
import MenSh2 from './sh3-2.jpeg'
import MenSh3 from './sh3-3.jpeg'
import MenSh4 from './sh3-4.jpeg'
import sale1 from './sale_banner15.jpg'
import sale2 from './sale_banner14.jpg'
...
function Shoe3 (){
    ...
    var [total, setTotal] = useState(652);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(652 * (quantity + 1))
        setfinalPrice((652*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Sir Corbett</p>
            <p class="shirt-name">Men Black Solid Slip On Formal Shoes</p>
            <p class="ratings">4.1 | 367 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹652</p>
            <p class="base-price">₹2329</p>
            <p class="dis-available">(72% Off)</p>
