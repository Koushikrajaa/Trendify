...
import MenSh1 from './cm6-1.jpeg'
import MenSh2 from './cm6-2.jpeg'
import MenSh3 from './cm6-3.jpeg'
import MenSh4 from './cm6-4.jpeg'
...
function Men6 (){
    ...
    var [total, setTotal] = useState(560);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(560 * (quantity + 1))
        setfinalPrice((560*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Men Navy Blue Slim Fit Casual Shirt</p>
            <p class="ratings">3.5 | 159 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹560</p>
            <p class="base-price">₹1699</p>
            <p class="dis-available">(67% Off)</p>
