...
import MenSh1 from './sun2-1.jpeg'
import MenSh2 from './sun2-2.jpeg'
import MenSh3 from './sun2-3.jpeg'
import MenSh4 from './sun2-4.jpeg'
...
function Sun2 (){
    ...
    var [total, setTotal] = useState(920);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(920 * (quantity + 1))
        setfinalPrice((920*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Voyage</p>
            <p class="shirt-name">UV Protected Round Sunglasses</p>
            <p class="ratings">4.3 | 746 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹920</p>
            <p class="base-price">₹1999</p>
            <p class="dis-available">(48% Off)</p>
