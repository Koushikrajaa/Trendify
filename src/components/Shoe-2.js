...
import MenSh1 from './sh2-1.jpeg'
import MenSh2 from './sh2-2.jpeg'
import MenSh3 from './sh2-3.jpeg'
import MenSh4 from './sh2-4.jpeg'
...
function Shoe2 (){
    ...
    var [total, setTotal] = useState(719);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(719 * (quantity + 1))
        setfinalPrice((719*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Woakers</p>
            <p class="shirt-name">Men Blue Colourblocked Sneakers</p>
            <p class="ratings">4.5 | 589 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹719</p>
            <p class="base-price">₹3995</p>
            <p class="dis-available">(82% Off)</p>
