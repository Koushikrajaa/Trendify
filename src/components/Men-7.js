...
import MenSh1 from './fm3-1.jpeg'
import MenSh2 from './fm3-2.jpeg'
import MenSh3 from './fm3-3.jpeg'
import MenSh4 from './fm3-4.jpeg'
import sale1 from './sale_banner7.jpg'
import sale2 from './sale_banner10.jpg'
...
function Men7 (){
    ...
    var [total, setTotal] = useState(459);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(459 * (quantity + 1))
        setfinalPrice((459*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">FUBAR</p>
            <p class="shirt-name">Mandarin Collar Cotton Plain Shirt</p>
            <p class="ratings">4.2 | 613 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹459</p>
            <p class="base-price">₹1999</p>
            <p class="dis-available">(75% Off)</p>
