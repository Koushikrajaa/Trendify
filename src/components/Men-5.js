...
import MenSh1 from './cm7-1.jpeg'
import MenSh2 from './cm7-2.jpeg'
import MenSh3 from './cm7-3.jpeg'
import MenSh4 from './cm7-4.jpeg'
...
function Men5 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Mens Washed Denim Jacket</p>
            <p class="ratings">4.0 | 632 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹999</p>
            <p class="base-price">₹2299</p>
            <p class="dis-available">(58% Off)</p>
