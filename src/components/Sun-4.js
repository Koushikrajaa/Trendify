...
import MenSh1 from './sun4-1.jpeg'
import MenSh2 from './sun4-2.jpeg'
import MenSh3 from './sun4-3.jpeg'
import MenSh4 from './sun4-4.jpeg'
...
function Sun4 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Eyewearlabs</p>
            <p class="shirt-name">Aviators with Polarised Lens</p>
            <p class="ratings">4.2 | 486 Ratings</p>
            <hr class="hr-line"></hr>
