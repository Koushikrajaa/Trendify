...
import MenSh1 from './sm2-1.jpeg'
import MenSh2 from './sm2-2.jpeg'
import MenSh3 from './sm2-3.jpeg'
import MenSh4 from './sm2-4.jpeg'
import sale1 from './sale_banner12.jpg'
import sale2 from './sale_banner4.jpg'
...
function Men12 (){
    ...
    var [total, setTotal] = useState(671);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(671 * (quantity + 1))
        setfinalPrice((671*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Roadster</p>
            <p class="shirt-name">Men Yellow Hooded Sweatshirt</p>
            <p class="ratings">4.3 | 373 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹671</p>
            <p class="base-price">₹1799</p>
