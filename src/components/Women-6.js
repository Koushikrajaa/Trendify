...
import MenSh1 from './wc6-1.jpeg'
import MenSh2 from './wc6-2.jpeg'
import MenSh3 from './wc6-3.jpeg'
import MenSh4 from './wc6-4.jpeg'
...
function Women6 (){
    ...
    var [total, setTotal] = useState(659);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(659 * (quantity + 1))
        setfinalPrice((659*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Nayo</p>
            <p class="shirt-name">Women Black & White Printed Kurta</p>
            <p class="ratings">4.5 | 724 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹659</p>
            <p class="base-price">₹1099</p>
            <p class="dis-available">(40% Off)</p>
