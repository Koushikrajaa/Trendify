...
import MenSh1 from './cm3-1.jpeg'
import MenSh2 from './cm3-2.jpeg'
import MenSh3 from './cm3-3.jpeg'
import MenSh4 from './cm3-4.jpeg'
import sale1 from './sale_banner4.jpg'
import sale2 from './sale_banner.jpg'
...
function Men2 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">The Bear House</p>
            <p class="shirt-name">Slim Fit Casual White Shirt</p>
            <p class="ratings">4.6 | 396 Ratings</p>
            <hr class="hr-line"></hr>
