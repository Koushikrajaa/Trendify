...
import MenSh1 from './kid1-1.jpeg'
import MenSh2 from './kid1-2.jpeg'
import MenSh3 from './kid1-3.jpeg'
import MenSh4 from './kid1-4.jpeg'
import sale1 from './sale_banner3.jpg'
...
function Kid1 (){
    ...
    var [total, setTotal] = useState(924);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(924 * (quantity + 1))
        setfinalPrice((924*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">A.T.U.N</p>
            <p class="shirt-name">ATUN Yellow Striped Shirt Dress</p>
            <p class="ratings">4.3 | 453 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹924</p>
            <p class="base-price">₹2499</p>
            <p class="dis-available">(63% Off)</p>
