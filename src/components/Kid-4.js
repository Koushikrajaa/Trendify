...
import MenSh1 from './kid4-1.jpeg'
import MenSh2 from './kid4-2.jpeg'
import MenSh3 from './kid4-3.jpeg'
import MenSh4 from './kid4-4.jpeg'
import sale1 from './sale_banner10.jpg'
...
function Kid4 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">FASHION DREAM</p>
            <p class="shirt-name">Girls Blue Western Dress</p>
            <p class="ratings">4.6 | 539 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹999</p>
            <p class="base-price">₹1999</p>
            <p class="dis-available">(50% Off)</p>
