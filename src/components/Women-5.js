...
import MenSh1 from './wc5-1.jpeg'
import MenSh2 from './wc5-2.jpeg'
import MenSh3 from './wc5-3.jpeg'
import MenSh4 from './wc5-4.jpeg'
import sale1 from './sale_banner10.jpg'
import sale2 from './sale_banner7.jpg'
...
function Women5 (){
    ...
    var [total, setTotal] = useState(723);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(723 * (quantity + 1))
        setfinalPrice((723*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Women Blue & White Printed Kurta</p>
            <p class="ratings">4.0 | 263 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹723</p>
            <p class="base-price">₹1149</p>
            <p class="dis-available">(37% Off)</p>
