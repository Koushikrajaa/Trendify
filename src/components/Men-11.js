...
import MenSh1 from './cm1-1.jpeg'
import MenSh2 from './cm1-2.jpeg'
import MenSh3 from './cm1-3.jpeg'
import MenSh4 from './cm1-4.jpeg'
...
function Men11 (){
    ...
    var [total, setTotal] = useState(784);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(784 * (quantity + 1))
        setfinalPrice((784*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Highstar</p>
            <p class="shirt-name">Olive Green Checked Casual Shirt</p>
            <p class="ratings">4.3 | 373 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹784</p>
            <p class="base-price">₹1099</p>
            <p class="dis-available">(35% Off)</p>
