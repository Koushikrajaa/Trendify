...
import MenSh1 from './wat4-1.jpeg'
import MenSh2 from './wat4-2.jpeg'
import MenSh3 from './wat4-3.jpeg'
import MenSh4 from './wat4-4.jpeg'
...
function Watch3 (){
    ...
    var [total, setTotal] = useState(999);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(999 * (quantity + 1))
        setfinalPrice((999*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Fire-Boltt</p>
            <p class="shirt-name">Smartwatch With Full Touch Display</p>
            <p class="ratings">4.2 | 692 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹999</p>
            <p class="base-price">₹3999</p>
            <p class="dis-available">(25% Off)</p>
