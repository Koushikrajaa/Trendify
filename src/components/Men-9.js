...
import MenSh1 from './cm8-1.jpeg'
import MenSh2 from './cm8-2.jpeg'
import MenSh3 from './cm8-3.jpeg'
import MenSh4 from './cm8-4.jpeg'
...
function Men9 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="ratings">4.5 | 759 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹799</p>
            <p class="base-price">₹1000</p>
            <p class="dis-available">(21% Off)</p>
