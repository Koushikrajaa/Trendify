...
import MenSh1 from './sh4-1.jpeg'
import MenSh2 from './sh4-2.jpeg'
import MenSh3 from './sh4-3.jpeg'
import MenSh4 from './sh4-4.jpeg'
import sale1 from './sale_banner13.jpeg'
import sale2 from './sale_banner15.jpg'
...
function Shoe4 (){
    ...
    var [total, setTotal] = useState(539);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(539 * (quantity + 1))
        setfinalPrice((539*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">CLYMB</p>
            <p class="shirt-name">Men Black Solid Slip On Formal Shoes</p>
            <p class="ratings">4.6 | 297 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹539</p>
            <p class="base-price">₹999</p>
            <p class="dis-available">(46% Off)</p>
