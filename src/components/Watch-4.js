...
import MenSh1 from './wat5-1.jpeg'
import MenSh2 from './wat5-2.jpeg'
import MenSh3 from './wat5-3.jpeg'
import MenSh4 from './wat5-4.jpeg'
import sale1 from './sale_banner7.jpg'
import sale2 from './sale_banner9.jpg'
...
function Watch4 (){
    ...
    var [total, setTotal] = useState(779);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(779 * (quantity + 1))
        setfinalPrice((779*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">boAt</p>
            <p class="shirt-name">Wave Beat M Smartwatch</p>
            <p class="ratings">4.6 | 583 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹779</p>
            <p class="base-price">₹2599</p>
            <p class="dis-available">(60% Off)</p>
            <p class="taxes">inclusive of all taxes</p>

            <p class="sel-size">Select Size in mm</p>
            <div class="size-sec">
            <input type="radio" class="size-s" name="size" value="small"></input>
                <label for="small" class="S">38</label>

                <input type="radio" class="size-m" name="size" value="medium"></input>
                <label for="small" class="M">40</label>

                <input type="radio" class="size-l" name="size" value="large"></input>
                <label for="small" class="L">42</label>

                <input type="radio" class="size-xl" name="size" value="X-large"></input>
                <label for="small" class="XL">44</label>

                <input type="radio" class="size-xxl" name="size" value="XX-large"></input>
                <label for="small" class="XXL">46</label>
            </div>
