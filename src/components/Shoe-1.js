...
import MenSh1 from './sh1-1.jpeg'
import MenSh2 from './sh1-2.jpeg'
import MenSh3 from './sh1-3.jpeg'
import MenSh4 from './sh1-4.jpeg'
...
function Shoe1 (){
    ...
    var [total, setTotal] = useState(579);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(579 * (quantity + 1))
        setfinalPrice((579*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Mast & Harbour</p>
            <p class="shirt-name">Volt Men Black Analogue watch</p>
            <p class="ratings">4.3 | 698 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹579</p>
            <p class="base-price">₹1999</p>
            <p class="dis-available">(71% Off)</p>
