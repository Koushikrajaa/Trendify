...
import MenSh1 from './kid8-1.jpeg'
import MenSh2 from './kid8-2.jpeg'
import MenSh3 from './kid8-3.jpeg'
import MenSh4 from './kid8-4.jpeg'
...
function Kid8 (){
    ...
    var [total, setTotal] = useState(985);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(985 * (quantity + 1))
        setfinalPrice((985*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Gilrs Black Floral Printed Dress</p>
            <p class="ratings">4.1 | 756 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹985</p>
            <p class="base-price">₹1999</p>
            <p class="dis-available">(55% Off)</p>
