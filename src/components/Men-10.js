...
import MenSh1 from './cm9-1.jpeg'
import MenSh2 from './cm9-2.jpeg'
import MenSh3 from './cm9-3.jpeg'
import MenSh4 from './cm9-4.jpeg'
...
function Men10 (){
    ...
    var [total, setTotal] = useState(910);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(910 * (quantity + 1))
        setfinalPrice((910*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Men Slim Fit Checked Casual Shirt</p>
            <p class="ratings">4.8 | 816 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹910</p>
