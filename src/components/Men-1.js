...
import MenSh1 from './fm2-1.jpeg'
import MenSh2 from './fm2-2.jpeg'
import MenSh3 from './fm2-3.jpeg'
import MenSh4 from './fm2-4.jpeg'
...
function Men1 (){
    ...
    var [total, setTotal] = useState(749);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(749 * (quantity + 1))
        setfinalPrice((749*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Slim Fit Formal Blue Shirt</p>
            <p class="ratings">4.2 | 52 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹749</p>
