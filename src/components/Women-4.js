...
import MenSh1 from './wc3-1.jpeg'
import MenSh2 from './wc3-2.jpeg'
import MenSh3 from './wc3-3.jpeg'
import MenSh4 from './wc3-4.jpeg'
...
function Women4 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">MIRCHI FASHION</p>
            <p class="shirt-name">Pink & Blue Floral Saree</p>
            <p class="ratings">4.0 | 263 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹671</p>
            <p class="base-price">₹2799</p>
            <p class="dis-available">(76% Off)</p>
