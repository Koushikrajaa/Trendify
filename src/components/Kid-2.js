...
import MenSh1 from './kid2-1.jpeg'
import MenSh2 from './kid2-2.jpeg'
import MenSh3 from './kid2-3.jpeg'
import MenSh4 from './kid2-4.jpeg'
...
function Kid2 (){
    ...
    var [total, setTotal] = useState(684);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(684 * (quantity + 1))
        setfinalPrice((684*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Pspeaches</p>
            <p class="shirt-name">ATUN Yellow Striped Shirt Dress</p>
            <p class="ratings">4.1 | 652 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹684</p>
            <p class="base-price">₹2282</p>
            <p class="dis-available">(70% Off)</p>
