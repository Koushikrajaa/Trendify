...
import MenSh1 from './sm1-1.jpeg'
import MenSh2 from './sm1-2.jpeg'
import MenSh3 from './sm1-3.jpeg'
import MenSh4 from './sm1-4.jpeg'
...
function Men4 (){
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Men Navy Blue Solid Sweatshirt</p>
            <p class="ratings">4.6 | 512 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹719</p>
            <p class="base-price">₹1199</p>
