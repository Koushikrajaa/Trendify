...
import MenSh1 from './cm4-1.jpeg'
import MenSh2 from './cm4-2.jpeg'
import MenSh3 from './cm4-3.jpeg'
import MenSh4 from './cm4-4.jpeg'
...
function Men3 (){
    ...
    var [total, setTotal] = useState(524);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(524 * (quantity + 1))
        setfinalPrice((524*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Men Navy & Grey Checked Casual Shirt</p>
            <p class="ratings">3.9 | 266 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹524</p>
            <p class="base-price">₹1499</p>
