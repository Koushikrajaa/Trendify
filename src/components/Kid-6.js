...
import MenSh1 from './kid6-1.jpeg'
import MenSh2 from './kid6-2.jpeg'
import MenSh3 from './kid6-3.jpeg'
import MenSh4 from './kid6-4.jpeg'
...
function Kid6 (){
    ...
    var [total, setTotal] = useState(610);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(610 * (quantity + 1))
        setfinalPrice((610*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <hr class="hr-line"></hr>
            <p class="dis-price">₹610</p>
            <p class="base-price">₹1299</p>
            <p class="dis-available">(52% Off)</p>
