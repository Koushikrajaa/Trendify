...
import MenSh1 from './wc9-1.jpeg'
import MenSh2 from './wc9-3.jpeg'
import MenSh3 from './wc9-2.jpeg'
import MenSh4 from './wc9-4.jpeg'
...
function Women9 (){
    ...
    var [total, setTotal] = useState(799);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(799 * (quantity + 1))
        setfinalPrice((799*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="brand-name">Biba</p>
            <p class="shirt-name">Women Pink & White Printed Kurta</p>
            <p class="ratings">3.9 | 159 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹799</p>
