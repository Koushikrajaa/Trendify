...
import MenSh1 from './wc2-1.jpeg'
import MenSh2 from './wc2-2.jpeg'
import MenSh3 from './wc2-3.jpeg'
import MenSh4 from './wc2-4.jpeg'
...
function Women2 (){
    ...
    var [total, setTotal] = useState(839);
    
    var increment = () => {
        setQuantity(quantity + 1);
        setTotal(839 * (quantity + 1))
        setfinalPrice((839*100)*(quantity+1))
      };
    ...
    return (
        ...
        <div class="main-sec">
            ...
            <p class="shirt-name">Sea Green & Gold-Toned Zari Saree</p>
            <p class="ratings">4.0 | 263 Ratings</p>
            <hr class="hr-line"></hr>
            <p class="dis-price">₹839</p>
            <p class="base-price">₹2999</p>
